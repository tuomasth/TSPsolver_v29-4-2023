...
Javadoc is not available on GitHub for this version. This version is only an experiment and should not be taken seriously like the other versions should.
